...
<a href="#main-content" class="sr-only">Skip to main content</a>
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page6.do${wrAjax ? '#!ajax=true' : ''}" styleId="page6FormBean" enctype="multipart/form-data">
			<html:hidden property="lastURL" styleId="lastURL_page6"/>
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp">WebRatio</a>
			</div>
			<div class="navbar-collapse collapse">		      
	            <ul class="nav navbar-nav" role="menu">
								<li class="active dropdown">
									<a href="<webratio:Link escapeXml="true" link=""/>" class="dropdown-toggle" data-toggle="dropdown" data-target="#">Consumptions<span class="caret"></span></a>
									<ul class="dropdown-menu" role="menu">
													<li>	
 <a class="" href="<webratio:Link link="page6.link"/>">
   Page 6
</a>
 </li>
									</ul>
...
<div class="container container-fixed-top-padding">
	<ol class="breadcrumb" aria-label="breadcrumbs">
		 <li>	
 <a class="small" href="<webratio:Link link=""/>">
   Consumptions
</a>
 </li>
					...
					<c:set var="index" value="${status.index}"/>	
						<tr <c:if test="${pwu2.currentIndex eq index}">class="info"</c:if>>	
								...
								<td class=" decimal">
									...
									<td class=" smallcol">
										 <a title="Flow24" id="ln24" class=" " href="<webratio:Link link="ln24" position="index"/>" >
			Flow24</a>
									</td>
						</tr>
					</c:forEach>
